...
export default function Hero({ onShowPerformance }) {
  ...
  return (
    <section style={{
      ...
      <div style={{
        position: 'absolute', inset: 0, pointerEvents: 'none', zIndex: 0, opacity: 0.28,
        backgroundImage: `linear-gradient(rgba(120,245,27,0.018) 1px, transparent 1px), linear-gradient(90deg, rgba(120,245,27,0.018) 1px, transparent 1px)`,
      ...
      <div style={{
        ...
        width: isMobile ? '400px' : '900px', height: isMobile ? '400px' : '680px',
        background: `radial-gradient(ellipse at center, rgba(120,245,27,0.15) 0%, rgba(82,216,11,0.065) 34%, transparent 69%)`,
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div style={{
          ...
          <a href="#enroll" style={{
            ...
            letterSpacing: '-0.01em', color: '#071006',
            background: 'linear-gradient(105deg, #B6FF68 0%, #8DF333 35%, #68E51A 68%, #4FCB0A 100%)',
            border: '1px solid rgba(210,255,180,0.28)',
            boxShadow: '0 14px 38px rgba(82,216,11,0.25), 0 2px 8px rgba(0,0,0,0.28)',
            transition: 'all 0.22s ease',
            width: isMobile ? '100%' : 'auto', textAlign: 'center',
          }}
            onMouseEnter={e => {
              e.currentTarget.style.transform = 'translateY(-3px) scale(1.015)'
              e.currentTarget.style.boxShadow = '0 19px 50px rgba(82,216,11,0.38)'
            }}
            onMouseLeave={e => {
              e.currentTarget.style.transform = 'translateY(0) scale(1)'
              e.currentTarget.style.boxShadow = '0 14px 38px rgba(82,216,11,0.25)'
            }}
          >Join the Community {'→'}</a>

          <button onClick={onShowPerformance} style={{
            padding: '16px 32px', borderRadius: '15px',
            fontFamily: 'Inter, sans-serif', fontWeight: 600, fontSize: '0.96rem',
            color: '#E2EAE2', background: 'rgba(255,255,255,0.018)',
